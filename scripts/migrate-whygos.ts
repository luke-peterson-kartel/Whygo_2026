...
const WHYGO_PATHS = {
  ...
  departments: [
    path.join(__dirname, '../WhyGos/WHYGOS _Company_Department/Company Whygos/Sales_Department_WhyGOs_2026(Final).md'),
    path.join(__dirname, '../WhyGos/WHYGOS _Company_Department/Company Whygos/Production_Department_WhyGOs_2026(Final).md'),
    path.join(__dirname, '../WhyGos/WHYGOS _Company_Department/Company Whygos/Platform_Department_WhyGOs_2026(Final).md'),
